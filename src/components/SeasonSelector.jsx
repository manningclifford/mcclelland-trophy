...
export default function SeasonSelector({ selectedYear, onYearChange, isLoading }) {
  return (
    <div className="flex items-center gap-4">
      <label htmlFor="season-select" className="font-medium text-stone-700">
        Season:
      </label>
      <select
        id="season-select"
        ...
        disabled={isLoading}
        className="px-4 py-2 border border-stone-300 bg-white focus:outline-none focus:ring-2 focus:ring-stone-400 disabled:bg-stone-100 disabled:cursor-not-allowed"
      >
